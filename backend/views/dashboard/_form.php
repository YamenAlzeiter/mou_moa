...
<div class="agreement-form">
    ...
    <?= $form->field($model, 'transfer_to')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'doc_executed')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pi_name_extra')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pi_kulliyyah_extra')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pi_phone_number_extra')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pi_email_extra')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pi_name_extra2')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pi_kulliyyah_extra2')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pi_phone_number_extra2')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pi_email_extra2')->textInput(['maxlength' => true]) ?>
